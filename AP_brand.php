...
<body>
  ...
  <div class="carousel-inner hero-slider w-100">
    <div class="carousel-item active">
      <img src="images\ben-mathis-seibel-dNnvotbg35Q-unsplash.jpg" class="d-block w-100 slider-img" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images\wp4112654-audemars-piguet-wallpapers.jpg" class="d-block w-100 slider-img" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images\wallpaperflare.com_wallpaper (5).jpg" class="d-block w-100 slider-img" alt="...">
    </div>
  </div>
  ...
  $collect_from_db = mysqli_query($conn, "SELECT * FROM `products_tb` WHERE product_brand = 'AP' ") or die ('Query Failed');
...
$collect_from_db = mysqli_query($conn, "SELECT * FROM `products_tb` WHERE product_brand = 'AP' AND product_discount = 'true' ") or die('Query Failed');
...
if (mysqli_num_rows($collect_from_db) > 0) {
  ...
  echo '<h3 class="text-center mt-3">Unfortunately Nothing is currently on sale</h3>';
}
?>
