  ...
  <div class="search-container w-100 sticky-top">
    ...
    <div class="row mt-5">
      <div class="col-6 text-center ">
        <img src="<?php
              $imagesrc = $admin_info_row['admin_image'];
              echo $imagesrc;
              ?>"
                alt="Avatar" class="text-center user-profile-picture" ; />
                <h5 class="profile-text text-center mt-2"><?php
              echo $admin_info_row['admin_fullname'];
              ?></h5>
              <p class="text-center">admin</p>
              <div class="buttton-cont text-center">
                
              <button class="pen-icon-button infinite-btns " onclick="changeToAdminUpdate()">
      ...
      <div class="row pt-1">
              ...
              echo $admin_info_row['admin_email'];
              ?></p>
                  </div>
                  <div class="col-6 mb-3">
                    <h5>Phone</h5>
                    <p class="text-muted"><?php
              echo $admin_info_row['admin_mobile_number'];
              ?></p>
                  </div>
                </div>
                <div class="row pt-1">
                  <div class="col-6 mb-3">
                    <h5>Home address</h5>
                    <p class="text-muted"><?php
              echo $admin_info_row['admin_address'];
              ?></p>
                  </div>
                  <div class="col-6 mb-3">
                    <h5>Status</h5>
                  ...
                  <!-- <div class="col-6 mb-3">
                    <h6>Password</h6>
                    <p class="text-muted"><?php
              echo $admin_info_row['admin_password'];
              ?></p>
                  </div> -->
