...
<body>
  ...
  <div class="carousel-inner hero-slider w-100">
    <div class="carousel-item active">
      <img src="images\wallpaperflare.com_wallpaper (2).jpg" class="d-block w-100 slider-img" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images\gold rolex bg.jpg" class="d-block w-100 slider-img" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images\silver bg.jpg" class="d-block w-100 slider-img" alt="...">
    </div>
  </div>
  ...
  $collect_from_db = mysqli_query($conn, "SELECT * FROM `products_tb` WHERE product_brand = 'rolex' ") or die ('Query Failed');
  ...
  ?>
    ...
    <!-- On Sale Section -->
    <section class="on-sale-section pb-5 pt-4 mb-2">
...
$collect_from_db = mysqli_query($conn, "SELECT * FROM `products_tb` WHERE product_brand = 'rolex' AND product_discount = 'true' ") or die('Query Failed');
